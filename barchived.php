...
<h3 class="text-center">ARCHIVED</h3><br>
		...
		<?php 
		 ...
		 $tech_search_query=mysql_query("SELECT * FROM technician Where tech_id='$issue_to_id'") or die(mysql_error());
				...
				<tr>
					...
					<th><a href="issue_return_inventory.php?tech_issue_id=<?php echo $row['tech_id'];?>">VIEW ACTIVE</a></th>
				</tr>
							  ...
							  }elseif (($row['b_tquantity']) == ($row['b_tquantity'] - $row['b_return_quantity'])) 
							  {
							   ...
							   ?>>
							 	...
							 	<td class="text-center">
											...
											<button  class="commonClass-<?php echo $row['b_id'];?> btn btn-danger">RETURN</button>
											...
											<div class="b_close">
												...
												<table class="table ">
													<tr>
														<td>
															<a class="btn btn-success btn-lg" style="width: 100%;" href="return_inventory_modify_archived.php?r_b_id=<?php echo $row['b_id']; ?>">YES</a>
														</td>
														<td>
															<a class="btn btn-danger btn-lg" style="width: 100%;" href="#">No</a>
														</td>
													</tr>
												</table>		
											</div>
