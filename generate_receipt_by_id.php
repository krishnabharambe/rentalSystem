...
<?php 
		$borrowdetails_search_query=mysql_query("SELECT b_rec_id FROM borrowdetails where b_tech_id=$issue_to_id GROUP BY b_rec_id" ) or die(mysql_error());
...
<div>
	<div class="panel panel-default">
	    ...
	    <?php $b_rec_id =$row['b_rec_id'];  ?>
	    <div><p style="font-size: 1.2em; ">Receipt ID : <strong><?php echo $b_rec_id; ?></strong></p></div>
	    </div>
	    ...
	    <table class="table table-bordered">
		 			...
		 			<tbody>
	     <?php get_receipt_by_rec_id($issue_to_id,$b_rec_id); ?>
	     </tbody>
	     </table>
	    </div>
	    <div class="panel-footer">
	    	<div style="float: right">
	    		<a href="print_receipt_by_rec_id.php?issue_to_id=<?php echo $issue_to_id ?>&rec_id=<?php echo $b_rec_id ?>" class="btn btn-success " style="width: 150px;"><span class="glyphicon glyphicon-print "></span> Print</a>
	    	</div>
	    </div>
  	</div>
</div>
