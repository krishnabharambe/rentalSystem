...
$borrowdetails_search_query96=mysql_query("SELECT * FROM borrowdetails where b_tech_id='$issue_to_id' AND b_rec_id = '$rec_id'" ) or die(mysql_error());
...
$borrowdetails_search_query96=mysql_query("SELECT SUM(total_cost) as total FROM borrowdetails where b_tech_id='$issue_to_id' AND b_rec_id = '$rec_id'" ) or die(mysql_error());
